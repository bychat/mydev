...
import type { GitHubIssueFilterState } from '../../main/github';
...
router.post('/supabase/detect', (req, res) => {
  try {
    const { detectSupabaseConfig } = require('../../main/supabase');
...
router.post('/supabase/users', async (req, res) => {
  try {
    const { fetchSupabaseUsers } = await import('../../main/supabase');
...
router.post('/supabase/storage', async (req, res) => {
  try {
    const { fetchSupabaseStorage } = await import('../../main/supabase');
...
router.post('/supabase/tables', async (req, res) => {
  try {
    const { fetchSupabaseTables } = await import('../../main/supabase');
...
router.post('/supabase/query', async (req, res) => {
  try {
    const { executeSupabaseQuery } = await import('../../main/supabase');
...
router.post('/github/extract-repo-info', async (req, res) => {
  try {
    const { extractRepoInfo } = await import('../../main/github');
...
router.get('/github/:owner/:repo/workflows', async (req, res) => {
  try {
    const { listWorkflows } = await import('../../main/github');
...
router.get('/github/:owner/:repo/runs', async (req, res) => {
  try {
    const { listWorkflowRuns } = await import('../../main/github');
...
router.get('/github/:owner/:repo/runs/:runId/jobs', async (req, res) => {
  try {
    const { listRunJobs } = await import('../../main/github');
...
router.get('/github/:owner/:repo/runs/:runId/logs', async (req, res) => {
  try {
    const { getRunLogs } = await import('../../main/github');
...
router.get('/github/:owner/:repo/jobs/:jobId/logs', async (req, res) => {
  try {
    const { getJobLogs } = await import('../../main/github');
...
router.post('/github/:owner/:repo/runs/:runId/rerun', async (req, res) => {
  try {
    const { rerunWorkflow } = await import('../../main/github');
...
router.get('/github/:owner/:repo/issues', async (req, res) => {
  try {
    const { listIssues } = await import('../../main/github');
...
router.post('/atlassian/test-connection', async (req, res) => {
  try {
    const { testConnection } = await import('../../main/atlassian');
...
router.post('/atlassian/projects', async (req, res) => {
  try {
    const { fetchProjects } = await import('../../main/atlassian');
...
router.post('/atlassian/issues', async (req, res) => {
  try {
    const { fetchProjectIssues } = await import('../../main/atlassian');
